				  ...
				  const media_frames_per_second *current_fps)
{
    ...
    //auto str = QTStr("Basic.PropertiesView.FPS.ValidFPSRanges");
     auto str = QString("Basic.PropertiesView.FPS.ValidFPSRanges");
    ...
    layout->addRow(QString("Basic.Settings.Video.Numerator"), num_edit);
    layout->addRow(QString
                 ("Basic.Settings.Video.Denominator"), den_edit);	widget->setLayout(layout);
